...
function calculate_collision_faces(object) {
	...
	for (var i = 0; i < buffer_get_size(model_buffer); i += 108) {
		...
		var x1 = buffer_peek(model_buffer, i + 0, buffer_f32);
		var y1 = buffer_peek(model_buffer, i + 4, buffer_f32);
		var z1 = buffer_peek(model_buffer, i + 8, buffer_f32);
			
		var x2 = buffer_peek(model_buffer, i + 36, buffer_f32);
		var y2 = buffer_peek(model_buffer, i + 40, buffer_f32);
		var z2 = buffer_peek(model_buffer, i + 44, buffer_f32);
		
		var x3 = buffer_peek(model_buffer, i + 72, buffer_f32);
		var y3 = buffer_peek(model_buffer, i + 76, buffer_f32);
		var z3 = buffer_peek(model_buffer, i + 80, buffer_f32);
